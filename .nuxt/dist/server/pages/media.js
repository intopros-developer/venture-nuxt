exports.ids = [139,19,21,25,29,30,33,35,41,42,43,44,46,68,77,84,97,103,104,105,109,114];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/media.vue?vue&type=template&id=1497f008&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.content)?_c('div',[_vm._ssrNode("<section class=\"contact-heroform group relative overflow-hidden bg-cover bg-center bg-no-repeat\"><video autoplay=\"autoplay\" loop=\"loop\" muted=\"muted\" playsinline class=\"responsive-contact-us-section-video absolute h-auto w-full object-cover\" style=\"min-height: 571px; height: 20vw\"><source"+(_vm._ssrAttr("src",_vm.content.bannerImgUrl))+" type=\"video/mp4\"></video> <div class=\"absolute left-0 top-0 z-0 h-full w-full bg-gradient-to-r from-[#2b3746] via-transparent\"></div> <div class=\"absolute bottom-0 left-0 h-[161px] w-full bg-gradient-to-t from-[#202a36] via-transparent opacity-80 xl:h-[214px]\"></div> <div class=\"container relative z-10 px-10 pb-9 pt-[287px] md:bg-left md:px-4 lg:px-[97px] xl:px-4 xl:pb-20 xl:pt-[164px]\"><div><p class=\"mb-5 border-l-[3px] border-primary pl-2.5 text-sm leading-3 text-[#FBFBFD] md:text-base md:leading-4\">"+_vm._ssrEscape("\n                    "+_vm._s(_vm.content.bannerSubtitle)+"\n                ")+"</p> <h1 class=\"mb-4 text-[28px] font-bold leading-8 text-white md:text-[40px] md:leading-[53px]\">"+_vm._ssrEscape(_vm._s(_vm.content.bannerTitle))+"</h1> <p class=\"w-full text-sm font-normal leading-5 text-[#FBFBFD] sm:max-w-[377px] md:max-w-[481px] md:text-base md:leading-[26px]\">"+(_vm._s(_vm.content.bannerDescription))+"</p></div></div></section> "),_c('common-banner-tab',{attrs:{"tabs":_vm.tabs,"is-show-save-btn":true}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"pb-20 pt-14 md:pb-32\">","</section>",[_vm._ssrNode("<div class=\"container px-10 md:px-4 lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div class=\"mb-8 flex items-center justify-center gap-2.5 text-center\"><div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div> <h2 id=\"aboutUs\" class=\"text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl\">"+(_vm._s(_vm.content.section1Title))+"</h2> <div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div></div> "),_c('common-toggle-content',{attrs:{"content":_vm.content.section1Paragraph}})],2)]),_vm._ssrNode(" "),_c('common-contact-us',{attrs:{"video-thumbnail-u-r-l":_vm.content.video1ThumbnailUrl,"button-title":_vm.content.video1ButtonText,"button-u-r-l":_vm.content.video1ButtonLink,"video-u-r-l":_vm.content.video1Url,"title":_vm.content.video1Title}}),_vm._ssrNode(" <section class=\"pt-[91px]\"><div class=\"container lg:px-[97px] xl:px-4\"><div id=\"mediaContacts\" class=\"mb-8 flex items-center justify-center gap-[33px] text-center\"><div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div> <h2 class=\"inline-block text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl\">"+(_vm._s(_vm.content.section2Title))+"</h2> <div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div></div> <div class=\"mt-[71px] grid grid-cols-1 divide-y divide-[#d5d5d5] border border-[#d5d5d5] sm:grid-cols-2 sm:divide-x lg:grid-cols-4 lg:divide-x lg:divide-y-0\">"+(_vm._ssrList((_vm.section2Data),function(contact,i){return ("<div class=\"px-[30px] pb-10 pt-11 lg:pb-[150px]\"><p class=\"text-[21px] font-semibold text-[#202a36]\">"+_vm._ssrEscape(_vm._s(contact.attributes.name))+"</p> <p class=\"line-clamp-2 min-h-[68px] pt-3 text-lg font-light text-[#202a36]\">"+_vm._ssrEscape(_vm._s(contact.attributes.location))+"</p> <a"+(_vm._ssrAttr("href",("mailto:" + (contact.attributes.email))))+" class=\"block pt-[30px] text-lg text-[#202a36] underline duration-150 hover:text-primary\">"+_vm._ssrEscape(_vm._s(contact.attributes.email))+"</a> <a"+(_vm._ssrAttr("href",("tel:" + (contact.attributes.phoneNumber))))+" class=\"block pt-2.5 text-lg text-[#202a36] duration-150 hover:text-primary\">"+_vm._ssrEscape(_vm._s(contact.attributes.phoneNumber))+"</a></div>")}))+"</div></div></section> "),_vm._ssrNode("<section class=\"pb-10 pt-20 md:pt-[166px] lg:pb-0\">","</section>",[_vm._ssrNode("<div class=\"container lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div class=\"grid grid-cols-1 space-y-20 md:grid-cols-2 md:gap-5 md:space-y-0 lg:gap-24 xl:gap-36\">","</div>",[_vm._ssrNode("<div><p class=\"text-[28px] font-bold leading-[60px] text-[#030303]\">"+(_vm._s(_vm.content.section3Column1Title))+"</p> <div class=\"pt-6 lg:pt-16\"><ul class=\"divide-y divide-[#d5d5d5] border-b border-t border-[#d5d5d5]\">"+(_vm._ssrList((_vm.section3Column1Data),function(socialMedia,index){return ("<li class=\"py-4\"><a"+(_vm._ssrAttr("href",socialMedia.attributes.url))+" target=\"_blank\" class=\"flex items-center justify-between text-lg text-[#202a36] hover:text-primary\"><span>"+_vm._ssrEscape(_vm._s(socialMedia.attributes.socialMediaName))+"</span> <div class=\"flex w-7 justify-center\">"+(_vm._s(_vm.getSocialMediaSVG(socialMedia.attributes.socialMediaName)))+"</div></a></li>")}))+"</ul></div></div> "),_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<p class=\"text-[28px] font-bold leading-[60px] text-[#030303]\">"+(_vm._s(_vm.content.section3Column2Title))+"</p> "),_vm._ssrNode("<div class=\"pt-6 lg:pt-16\">","</div>",[_vm._ssrNode("<ul class=\"divide-y divide-[#d5d5d5] border-b border-t border-[#d5d5d5]\">","</ul>",_vm._l((_vm.section3Column2Data),function(data,index){return _vm._ssrNode("<li class=\"flex items-center justify-between py-4 text-lg text-[#202a36] hover:text-primary\">","</li>",[_vm._ssrNode("<a target=\"_blank\""+(_vm._ssrAttr("href",data.attributes.subscribeToUrl))+">"+_vm._ssrEscape(_vm._s(data.attributes.subscribeTo))+"</a> "),_c('icons-right-menu-arrow',{staticClass:"text-[#00ADFF]"})],2)}),0)])],2)],2)])]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"py-10 md:py-16 xl:pb-0 xl:pt-[243px]\">","</section>",[_vm._ssrNode("<div class=\"container lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div id=\"featuredMediaMentions\" class=\"flex items-center justify-center gap-[33px] text-center\"><div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div> <h2 class=\"inline-block text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl\">"+(_vm._s(_vm.content.section4Title))+"</h2> <div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div></div> "),_vm._l((_vm.section4Data),function(media,index){return ((!_vm.moreMediaMentions && index < 3) || _vm.moreMediaMentions)?_vm._ssrNode("<div class=\"grid grid-cols-1 items-center space-y-4 pt-[67px] lg:grid-cols-3 lg:gap-y-14 lg:space-y-0\">","</div>",[_vm._ssrNode("<div><div><p class=\"text-sm font-semibold text-[#00a1f1]\">"+_vm._ssrEscape(_vm._s(media.attributes.title))+"</p> <p class=\"inline-block text-sm font-semibold text-[#646464] lg:block\">"+_vm._ssrEscape(_vm._s(media.attributes.mediaType)+" | "+_vm._s(media.attributes.date))+"</p></div></div> "),_vm._ssrNode("<div class=\"col-span-2\">","</div>",[_vm._ssrNode("<div class=\"flex items-start gap-[17px]\">","</div>",[_vm._ssrNode("<div class=\"flex h-[62px] w-[62px] shrink-0 items-center justify-center rounded-full bg-white p-[7px] shadow-[0px_1px_8px_rgba(0,0,0,0.2)]\">","</div>",[_c('nuxt-img',{attrs:{"format":"webp","src":media.attributes.iconUrl,"alt":media.attributes.title,"loading":"lazy"}})],1),_vm._ssrNode(" <div class=\"max-w-2xl pt-1 lg:pt-0\"><h4 class=\"text-xl font-semibold -tracking-[0.05px] text-[#030303] lg:text-[25px]\">"+_vm._ssrEscape(_vm._s(media.attributes.title))+"</h4> <p class=\"text-base -tracking-[0.03px] text-[#030303]\">"+_vm._ssrEscape(_vm._s(media.attributes.description))+"</p></div>")],2)])],2):_vm._e()}),_vm._ssrNode(" <div class=\"pt-7 text-center md:pt-20\"><button type=\"button\" class=\"outline-btn border-[#000]/[0.08] px-11 py-[18px] text-xs uppercase text-[#00a1f1]\">"+_vm._ssrEscape("\n                    "+_vm._s(_vm.moreMediaMentions ? 'Less media mentions' : 'More media mentions')+"\n                ")+"</button></div>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"py-10 md:py-16 xl:pb-[176px] xl:pt-[108px]\">","</section>",[_vm._ssrNode("<div class=\"container lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div id=\"pressRelease\" class=\"flex items-center justify-center gap-[33px] text-center\"><div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div> <h2 class=\"inline-block text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl\">"+(_vm._s(_vm.content.section5Title))+"</h2> <div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div></div> "),_vm._l((_vm.section5Data),function(release,index){return ((!_vm.morePressRelease && index < 3) || _vm.morePressRelease)?_vm._ssrNode("<div class=\"grid grid-cols-1 items-center space-y-4 pt-[67px] lg:grid-cols-3 lg:gap-y-14 lg:space-y-0\">","</div>",[_vm._ssrNode("<div><div><p class=\"text-sm font-semibold text-[#00a1f1]\">"+_vm._ssrEscape(_vm._s(release.attributes.title))+"</p> <p class=\"inline-block text-sm font-semibold text-[#646464] lg:block\">"+_vm._ssrEscape(_vm._s(release.attributes.type)+" | "+_vm._s(release.attributes.date))+"</p></div></div> "),_vm._ssrNode("<div class=\"col-span-2\">","</div>",[_vm._ssrNode("<div class=\"flex items-start gap-[17px]\">","</div>",[_vm._ssrNode("<div class=\"flex h-[62px] w-[62px] shrink-0 items-center justify-center rounded-full bg-white p-[7px] shadow-[0px_1px_8px_rgba(0,0,0,0.2)]\">","</div>",[_c('nuxt-img',{attrs:{"format":"webp","src":release.attributes.iconUrl,"alt":release.attributes.title,"loading":"lazy"}})],1),_vm._ssrNode(" <div class=\"max-w-2xl pt-1 lg:pt-0\"><h4 class=\"text-xl font-semibold -tracking-[0.05px] text-[#030303] lg:text-[25px]\">"+_vm._ssrEscape(_vm._s(release.attributes.title))+"</h4> <p class=\"text-base -tracking-[0.03px] text-[#030303]\">"+_vm._ssrEscape(_vm._s(release.attributes.description))+"</p></div>")],2)])],2):_vm._e()}),_vm._ssrNode(" <div class=\"pt-7 text-center md:pt-20\"><button type=\"button\" class=\"outline-btn border-[#000]/[0.08] px-11 py-[18px] text-xs uppercase text-[#00a1f1]\">"+_vm._ssrEscape("\n                    "+_vm._s(_vm.morePressRelease ? 'Less press releases' : 'More press releases')+"\n                ")+"</button></div>")],2)]),_vm._ssrNode(" "),_c('common-tell-more-about-projects',{attrs:{"featured-companies":_vm.section6Logos,"tell-us-more-data":_vm.section6Data,"tell-us-more-title":_vm.content.CTA1Title,"tell-use-more-subtitle":_vm.content.CTA1Description,"image-url":_vm.content.CTA1ImgUrl}}),_vm._ssrNode(" "),_c('common-client-words',{attrs:{"title":_vm.content.section7Title,"description":_vm.content.section7Description,"testimonials":_vm.section7Data}}),_vm._ssrNode(" "),_c('common-interested-service',{attrs:{"background-image":_vm.content.section8ImgUrl,"subtitle":_vm.content.section8Subtitle,"title":_vm.content.section8Title,"description":_vm.content.section8Description,"button-link":_vm.content.section8ButtonLink,"button-title":_vm.content.section8ButtonText}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"py-10 md:py-16 lg:py-20\">","</section>",[_vm._ssrNode("<div class=\"container lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div id=\"ventureInsight\" class=\"flex items-center justify-center gap-[33px] text-center\"><div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div> <h2 class=\"inline-block text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl\">"+(_vm._s(_vm.content.section9Title))+"</h2> <div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div></div> "),_vm._ssrNode("<div class=\"grid grid-cols-1 gap-5 pt-24 md:grid-cols-2 lg:grid-cols-3 xl:gap-[45px] xl:px-[93px]\">","</div>",_vm._l((_vm.section9Data),function(trend,i){return _vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div class=\"flex items-center gap-3 xl:gap-[52px]\">","</div>",[_vm._ssrNode("<div>","</div>",[_c('nuxt-link',{attrs:{"to":"/insights"}},[_c('nuxt-img',{staticClass:"h-28 w-28 rounded-[5px] object-cover shadow-[0_3px_6px_rgba(0,0,0,0.44)] xl:h-[127px] xl:w-[127px]",attrs:{"format":"webp","src":trend.attributes.imgUrl,"alt":trend.attributes.title,"loading":"lazy"}})],1)],1),_vm._ssrNode(" <div><p class=\"text-xl font-semibold text-[#030303]\">"+_vm._ssrEscape(_vm._s(trend.attributes.title))+"</p> <p class=\"text-sm font-semibold text-[#646464]\">"+_vm._ssrEscape(_vm._s(trend.attributes.numberOfInsights))+"</p></div>")],2)])}),0)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"pt-10 xl:pt-14\">","</section>",[_vm._ssrNode("<div class=\"container px-10 md:px-4 lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div class=\"mb-[59px] flex items-center justify-center gap-[33px] text-center xl:mb-[68px]\"><div class=\"hidden h-px w-full bg-[#D5D5D5] sm:block\"></div> <h2 class=\"text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl\">"+(_vm._s(_vm.content.section10Title))+"</h2> <div class=\"hidden h-px w-full bg-[#D5D5D5] sm:block\"></div></div> "),_vm._ssrNode("<div class=\"relative z-[1] grid grid-cols-1 md:grid-cols-2 lg:-mx-7 lg:grid-cols-4 lg:gap-y-28\">","</div>",_vm._l((_vm.section10Data),function(insight,i){return _vm._ssrNode("<div"+(_vm._ssrClass("mb-8 border-[#d5d5d5] sm:border-0 md:px-7 lg:border-r",{ '!border-0 lg:col-span-2': i === 2, '!border-0': i === 6, 'md:border-l lg:border-0': i % 2 !== 0 }))+">","</div>",[_vm._ssrNode("<div class=\"h-[125px] w-full shadow-[0px_3px_6px_rgba(0,0,0,0.6)] xl:h-[173px]\">","</div>",[_c('nuxt-img',{staticClass:"h-full w-full object-cover",attrs:{"format":"webp","src":insight.attributes.imgUrl,"alt":insight.attributes.Insightsource,"loading":"lazy"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex h-[calc(100%-125px)] flex-col justify-between py-3 xl:h-[calc(100%-173px)] xl:py-[34px]\">","</div>",[_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<p class=\"mb-3 text-sm font-semibold tracking-[0.31px] text-primary xl:mb-4 xl:-tracking-[0.03px]\">"+_vm._ssrEscape("\n                                "+_vm._s(insight.attributes.Insightsource)+"\n                            ")+"</p> "),_c('nuxt-link',{staticClass:"text-[21px] font-semibold leading-7 text-[#202A36]",attrs:{"to":("/insights/" + (insight.attributes.singleInsightPageSlug))}},[_vm._v(_vm._s(insight.attributes.title))]),_vm._ssrNode(" <p class=\"mb-5 mt-3 text-sm font-medium leading-6 -tracking-[0.03px] text-[#202A36] lg:mb-[54px] lg:text-base\">"+_vm._ssrEscape("\n                                "+_vm._s(insight.attributes.paragraph)+"\n                            ")+"</p>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"relative flex items-center justify-between\">","</div>",[_vm._ssrNode("<p class=\"inline-block text-[13px] font-medium leading-[14px] -tracking-[0.03px] text-[#646464] transition-all duration-300 xl:leading-[23px]\">"+_vm._ssrEscape("\n                                "+_vm._s(insight.attributes.insightType)+" | "+_vm._s(_vm.$helper.formatInsightPublishDate(insight.attributes.date))+"\n                            ")+"</p> "),_vm._ssrNode("<button type=\"button\">","</button>",[_c('common-share',{attrs:{"is-show-save-btn":true,"custom-link":("/insights/" + (insight.attributes.singleInsightPageSlug))}})],1)],2)],2)],2)}),0)],2)]),_vm._ssrNode(" "),_c('common-work-at-the-best-place',{attrs:{"img-url":_vm.content.CTA2ImgUrl,"title":_vm.content.CTA2Title,"description":_vm.content.CTA2Description,"button-title":_vm.content.CTA2ButtonText,"button-url":_vm.content.CTA2ButtonLink}}),_vm._ssrNode(" "),_c('common-readytotalk',{attrs:{"service-options":_vm.readyToTalkForm.services.data,"about-paragraph":_vm.readyToTalkForm.aboutParagraph,"title":_vm.readyToTalkForm.title,"talk-in-title":_vm.readyToTalkForm.talkInTitle,"img-url":_vm.readyToTalkForm.imgUrl}}),_vm._ssrNode(" "),_c('common-faq',{attrs:{"id":"faq","title":_vm.content.section11Title,"description":_vm.content.section11Description,"faqs":_vm.section11Data}}),_vm._ssrNode(" "),_c('common-brand-logo',{attrs:{"logos":_vm.logoSlider}})],2):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/media.vue?vue&type=template&id=1497f008&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3-0!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/media.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var mediavue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    section3Column1Data() {
      ...
      return ((_this$content13 = this.content) === null || _this$content13 === void 0 ? void 0 : (_this$content13$secti = _this$content13.section3Column1Component) === null || _this$content13$secti === void 0 ? void 0 : _this$content13$secti.data) || [];
    },
    section3Column2Data() {
      var _this$content14, _this$content14$secti;
      return ((_this$content14 = this.content) === null || _this$content14 === void 0 ? void 0 : (_this$content14$secti = _this$content14.section3Column2Component) === null || _this$content14$secti === void 0 ? void 0 : _this$content14$secti.data) || [];
    },
    section4Data() {
    ...
    section6Logos() {
      ...
      return ((_this$content18 = this.content) === null || _this$content18 === void 0 ? void 0 : (_this$content18$secti = _this$content18.section6LogoUrls) === null || _this$content18$secti === void 0 ? void 0 : _this$content18$secti.data) || [];
    },
    section7Data() {
      var _this$content19, _this$content19$secti;
      return ((_this$content19 = this.content) === null || _this$content19 === void 0 ? void 0 : (_this$content19$secti = _this$content19.section7Component) === null || _this$content19$secti === void 0 ? void 0 : _this$content19$secti.data) || [];
    },
    section9Data() {
    ...
    logoSlider() {
      var _this$content24, _this$content24$logoS, _this$content24$logoS2, _this$content24$logoS3;
      return ((_this$content24 = this.content) === null || _this$content24 === void 0 ? void 0 : (_this$content24$logoS = _this$content24.logoSlider) === null || _this$content24$logoS === void 0 ? void 0 : (_this$content24$logoS2 = _this$content24$logoS.data) === null || _this$content24$logoS2 === void 0 ? void 0 : (_this$content24$logoS3 = _this$content24$logoS2.attributes) === null || _this$content24$logoS3 === void 0 ? void 0 : _this$content24$logoS3.logoUrls) || [];
    }
  },
  mounted() {
    if (window.innerWidth <= 768) {
...
/* nuxt-component-imports */
installComponents(component, {CommonBannerTab: __webpack_require__(161).default,CommonToggleContent: __webpack_require__(149).default,CommonContactUs: __webpack_require__(139).default,IconsRightMenuArrow: __webpack_require__(24).default,CommonTellMoreAboutProjects: __webpack_require__(177).default,CommonClientWords: __webpack_require__(169).default,CommonInterestedService: __webpack_require__(145).default,CommonShare: __webpack_require__(143).default,CommonWorkAtTheBestPlace: __webpack_require__(182).default,CommonReadytotalk: __webpack_require__(140).default,CommonFaq: __webpack_require__(168).default,CommonBrandLogo: __webpack_require__(164).default})
