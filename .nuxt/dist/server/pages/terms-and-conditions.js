...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/terms-and-conditions.vue?vue&type=template&id=2ac90b7a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<section class=\"relative bg-[url('/assets/img/terms-and-conditions-top.png')] bg-cover bg-[right_48%_top] bg-no-repeat pb-9 pt-[164px] md:bg-[center_top_25%] xl:pb-[75px]\"><div class=\"absolute left-0 top-0 z-0 h-full w-[90%] bg-gradient-to-r from-[#2b3746] via-transparent\"></div> <div class=\"absolute bottom-0 left-0 h-[161px] w-full bg-gradient-to-t from-[#202a36] via-transparent opacity-80 xl:h-[246px]\"></div> <div class=\"container relative z-10 lg:px-[97px] xl:px-4\"><div><p class=\"mb-[18px] border-l-[3px] border-primary pl-2.5 leading-5 text-[#FBFBFD]\">Venture Plans, your dream starts with us.</p> <h1 class=\"mb-4 text-[38px] font-bold leading-[42px] text-white xl:text-[40px] xl:leading-[53px]\">Terms &amp; Conditions</h1></div></div></section> <section class=\"container mb-60 mt-24 lg:px-[97px] xl:px-4\">"+(_vm._ssrList((_vm.content),function(data,i){return ("<div"+(_vm._ssrClass("max-w-4xl",{ 'mb-6': i !== _vm.content.length - 1 }))+"><h5 class=\"mb-8 text-xl font-bold\">"+_vm._ssrEscape(_vm._s(data.title))+"</h5> <p>"+_vm._ssrEscape(_vm._s(data.description))+"</p></div>")}))+" <p>"+_vm._ssrEscape(_vm._s(_vm.copyrightText))+"</p> <p>"+_vm._ssrEscape(_vm._s(_vm.address))+"</p> <a"+(_vm._ssrAttr("href",("mailto:" + _vm.email)))+" class=\"underline\">"+_vm._ssrEscape(_vm._s(_vm.email))+"</a></section>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/terms-and-conditions.vue?vue&type=template&id=2ac90b7a&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3-0!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/terms-and-conditions.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var terms_and_conditionsvue_type_script_lang_js_ = ({
  data() {
    return {
      address: '750 North San Vicente, West Hollywood, California 90069',
      email: 'info@ventureplans.us',
      copyrightText: '© 2021 Venture Plans | Limited Liability Company',
      content: [{
        title: 'ACCEPTANCE OF TERMS',
        description: 'We’d like to welcome you to the Venture Plans corporate website. This Agreement sets forth the entire set of terms and restrictions that apply when you visit our site or choose to explore its contents. By accessing and using this website, you agree to abide by its terms of service and to accept as such. This Agreement encapsulates and replaces all earlier or contemporaneous agreements, representations, warranties, and understandings between us and you with respect to the Site and the content offered by or through the Site, as well as the subject areas of this Agreement.'
      }, {
        title: 'Transaction Processing',
        description: 'Clients must schedule a call from us to discuss their business plan. The venture plans advisors will contact the client to determine pricing within 5 days of the call, the client must pay 65 % of the agreed-upon sum. Any delays in the initial payment will result in a delay in the client’s order.'
      }, {
        title: 'Seller Damages for Non Acceptance of Repudiation',
        description: 'Under the uniform commercial code AO2-708, a buyer is liable for sellers damages of non-acceptance or repudiation due to reliance on the contract by, for example, incurred expenses in preparing to perform, or in the foregoing opportunities to make other contracts. Awarding a sum of money, not exceeding price of the contract, due to sellers damages based on his/her expectation interest, are indented to give him/her the benefit of his bargain by, to the extent possible putting the company in a good position as he would have been in had the contract been performed.'
      }, {
        title: 'Editing, Deleting, and Modification',
        description: 'By publishing a letter or a new agreement on our site, we may alter, remove, or update any of the terms and conditions stated in this Agreement at any time and at our sole discretion. YOUR ONGOING VISIT TO OUR WEBSITE AFTER WE POST A UPDATE NOTICE OR NEW TERMS ON OUR SITE WILL BE DEEMED BINDING ACCEPTANCE OF THE CHANGE.'
      }, {
        title: 'Fees',
...
The authorization or license granted by Venture Plans will be revoked if any unlawful use is made.`
        ...
        description: `We make no representations or warranties about the accuracy, completeness, reliability, currentness, or error-free nature of the service description or other content on this site.`
      }, {
        title: 'Refund policy',
...
Any waiver by either party of a breach of any term of this Agreement shall not be construed as a waiver of any future or previous violation of the same or any other provision.`
        ...
        description: 'If any section of these Provisions and Conditions is declared to be illegal or unenforceable by a court order or judgment, that provision will only apply to the extent permitted by law, and the remainder of these Terms and Conditions will remain valid and enforceable according to its terms.'
      }, {
        title: 'Entire Agreement',
        description: 'Without regard to conflict-of-laws rules, this Agreement shall be governed by and interpreted in conformity with the substantive laws of California, United States of America. The Agreement encapsulates and replaces all earlier or contemporaneous agreements, representations, warranties, and understandings between us and you with respect to the Site, the contents and materials offered by or through the Site, and the subject matter of this Agreement.'
      }, {
        title: 'GOVERNING LAW',
        description: `Any disagreement, scandal, or distinction between both the parties arising out of, in relation to, or in connection with this Agreement is hereby irrevocably submitted to the exclusive jurisdiction of the courts of California, United States of America, without regard to its conflict of laws provisions or your actual state or country of residence.`
      }]
    };
  },
  head() {
...
// CONCATENATED MODULE: ./pages/terms-and-conditions.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/terms-and-conditions.vue
