...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/media-mentions/index.vue?vue&type=template&id=32cd9279&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.content)?_c('div',[_vm._ssrNode("<section class=\"relative bg-cover bg-[right_32%_top] bg-no-repeat pb-10 pt-[166px] md:bg-left xl:pb-20\""+(_vm._ssrStyle(null,{ backgroundImage: ("url(" + (_vm.content.bannerImgUrl) + ")") }, null))+"><div class=\"absolute left-0 top-0 z-0 h-full w-full bg-gradient-to-r from-[#2b3746] via-transparent\"></div> <div class=\"absolute bottom-0 left-0 h-[161px] w-full bg-gradient-to-t from-[#202a36] via-transparent opacity-80 xl:h-[214px]\"></div> <div class=\"container relative z-10 md:px-4 lg:px-[97px] xl:px-4\"><div><p class=\"mb-5 border-l-[3px] border-primary pl-2.5 text-sm leading-3 text-[#FBFBFD] md:text-base md:leading-4\">"+_vm._ssrEscape("\n                    "+_vm._s(_vm.content.bannerSubtitle)+"\n                ")+"</p> <h1 class=\"mb-4 text-[38px] font-bold leading-[42px] text-white xl:text-[40px]\">"+_vm._ssrEscape(_vm._s(_vm.content.bannerTitle))+"</h1> <p class=\"font-normal leading-5 text-[#FBFBFD] md:whitespace-pre xl:leading-6\">"+(_vm._s(_vm.content.bannerDescription))+"</p></div></div></section> "),_vm._ssrNode("<section class=\"container mb-24 mt-24 lg:mb-20 lg:px-[97px] xl:px-4\">","</section>",[_vm._ssrNode("<p class=\"max-w-4xl\">"+_vm._ssrEscape(_vm._s(_vm.content.section1Description))+"</p> "),_vm._ssrNode("<div class=\"relative z-[1] mt-20 grid grid-cols-1 md:grid-cols-2 lg:-mx-7 lg:grid-cols-2 lg:gap-y-[40px]\">","</div>",_vm._l((_vm.mediaCatalogues),function(media,i){return _vm._ssrNode("<div"+(_vm._ssrClass("mb-16 border-[#d5d5d5] lg:px-7",{ 'md:border-r md:pr-7': i % 2 == 0, 'md:pl-7': i % 2 !== 0 }))+">","</div>",[_vm._ssrNode("<div class=\"h-[242px] w-full lg:h-[277px]\">","</div>",[_c('nuxt-img',{staticClass:"h-full w-full object-cover",staticStyle:{"box-shadow":"-2px -2px 15px 3px rgba(0, 0, 0, 0.25)"},attrs:{"format":"webp","src":media.attributes.imgUrl,"alt":media.attributes.title,"loading":"lazy"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div class=\"w-full lg:w-5/6\">","</div>",[_vm._ssrNode("<p class=\"my-5 line-clamp-1 text-sm font-semibold text-primary\">"+_vm._ssrEscape(_vm._s(media.attributes.mediaSource))+"</p> "),_vm._ssrNode("<div>","</div>",[_c('nuxt-link',{staticClass:"mb-5 line-clamp-2 block text-[24px] font-bold",attrs:{"to":'/media-mentions/' + media.attributes.singleMediaPageSlug}},[_vm._v(_vm._s(media.attributes.title))])],1),_vm._ssrNode(" <p class=\"mb-7 line-clamp-3 text-base text-[#202A36]\">"+_vm._ssrEscape(_vm._s(media.attributes.paragraph))+"</p>")],2),_vm._ssrNode(" "),_c('nuxt-link',{staticClass:"mb-10 flex w-[110px] items-center justify-center gap-2 rounded-md bg-primary py-[10px] text-[14px] text-white md:hover:bg-blue-500",attrs:{"to":'/media-mentions/' + media.attributes.singleMediaPageSlug}},[_vm._v("\n                        Visit News\n                        "),_c('svg',{attrs:{"width":"10","height":"10","viewBox":"0 0 10 10","fill":"none","xmlns":"http://www.w3.org/2000/svg"}},[_c('path',{attrs:{"d":"M0.575103 7.13197C0.233774 7.36663 0.147305 7.83357 0.381969 8.1749C0.616632 8.51623 1.08357 8.6027 1.4249 8.36803L0.575103 7.13197ZM9.73746 2.38657C9.81288 1.97928 9.54385 1.58796 9.13657 1.51254L2.49941 0.283436C2.09212 0.208013 1.70081 0.477042 1.62538 0.884331C1.54996 1.29162 1.81899 1.68294 2.22628 1.75836L8.12597 2.8509L7.03344 8.75059C6.95801 9.15788 7.22704 9.54919 7.63433 9.62462C8.04162 9.70004 8.43293 9.43101 8.50836 9.02372L9.73746 2.38657ZM1.4249 8.36803L9.4249 2.86803L8.5751 1.63197L0.575103 7.13197L1.4249 8.36803Z","fill":"white"}})])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex items-center justify-between\">","</div>",[_vm._ssrNode("<p class=\"inline-block text-[14px] font-medium leading-[14px] -tracking-[0.03px] text-[#646464] transition-all duration-300 xl:leading-[23px]\">"+_vm._ssrEscape("\n                            "+_vm._s(media.attributes.newsType)+" | "+_vm._s(_vm.$helper.formatInsightPublishDate(media.attributes.date))+"\n                        ")+"</p> "),_vm._ssrNode("<button type=\"button\">","</button>",[_c('common-share',{attrs:{"is-show-save-btn":true,"insights":true,"custom-link":("" + (media.attributes.singleMediaPageSlug))}})],1)],2)],2)],2)}),0)],2)],2):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/media-mentions/index.vue?vue&type=template&id=32cd9279&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3-0!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/media-mentions/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var media_mentionsvue_type_script_lang_js_ = ({
  ...
  computed: {
    mediaCatalogues() {
      var _this$content12, _this$content12$media;
      return (this === null || this === void 0 ? void 0 : (_this$content12 = this.content) === null || _this$content12 === void 0 ? void 0 : (_this$content12$media = _this$content12.mediaCatalogues) === null || _this$content12$media === void 0 ? void 0 : _this$content12$media.data) || [];
    }
  }
});
// CONCATENATED MODULE: ./pages/media-mentions/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_media_mentionsvue_type_script_lang_js_ = (media_mentionsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/media-mentions/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_media_mentionsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var media_mentions = __webpack_exports__["default"] = (component.exports);
