...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/founder.vue?vue&type=template&id=4166756a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<section class=\"relative h-[400px] bg-cover bg-[right_32%_top] bg-no-repeat pb-12 md:bg-[center_top_8%] lg:h-[800px] xl:bg-[center_top_12%] xl:pb-[67px]\""+(_vm._ssrStyle(null,{ backgroundImage: ("url(" + (_vm.content.bannerImgUrl) + ")") }, null))+"><div class=\"absolute left-0 top-0 z-0 h-full w-full bg-gradient-to-r from-[#2b3746] via-transparent\"></div> <div class=\"absolute bottom-0 left-0 h-[161px] w-full bg-gradient-to-t from-[#202a36] via-transparent opacity-80 xl:h-[500px]\"></div> <div class=\"container relative z-10 flex h-full items-center lg:px-[97px] xl:pl-20\"><div><div class=\"mb-[10px] flex gap-[10px]\"><div class=\"w-[3px] flex-none bg-primary\"></div> <p class=\"font-normal text-[#FBFBFD] sm:whitespace-pre\">"+(_vm._s(_vm.content.bannerSubtitle))+"</p></div> <h1 class=\"mb-4 text-[38px] font-bold leading-[42px] text-white xl:text-[60px] xl:leading-[53px]\">"+_vm._ssrEscape(_vm._s(_vm.content.bannerTitle))+"</h1> <p class=\"mb-5 text-[#fbfbfd]\">"+(_vm._s(_vm.content.bannerDescription))+"</p></div></div></section> "),_vm._ssrNode("<div class=\"pb-20\">","</div>",[_vm._ssrNode("<section class=\"pt-20 md:pt-28\">","</section>",[_vm._ssrNode("<div id=\"about\" class=\"px-10 md:px-4 lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div class=\"mb-8 flex items-center justify-center gap-[33px] text-center\"><div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div> <h3 class=\"text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl [&>span]:text-primary\">"+(_vm._s(_vm.content.section2Title))+"</h3> <div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div></div> "),_vm._ssrNode("<div class=\"container\">","</div>",[_c('common-toggle-content',{attrs:{"content":_vm.content.section2Description}})],1)],2)])]),_vm._ssrNode(" "),_c('common-contact-us',{attrs:{"video-thumbnail-u-r-l":_vm.content.video1ThumbnailUrl,"button-title":_vm.content.video1ButtonText,"button-u-r-l":_vm.content.video1ButtonLink,"video-u-r-l":_vm.content.video1Url,"title":_vm.content.video1Title,"less-padding-top":true}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"bg-white py-[60px]\">","</section>",[_vm._ssrNode("<div class=\"container px-10 md:px-4 lg:px-[97px] xl:px-4\">","</div>",[_vm._ssrNode("<div class=\"grid grid-cols-1\">","</div>",[_vm._ssrNode("<h3 class=\"pb-[43px] text-center text-2xl font-medium text-[#0B3A02] md:text-[31px]\">"+(_vm._s(_vm.content.section3Title))+"</h3> "),_vm._ssrNode("<div class=\"flex flex-wrap items-center justify-center gap-4 lg:gap-[50px]\">","</div>",_vm._l((_vm.section3Data),function(logo,i){return _vm._ssrNode("<div class=\"flex h-[88px] w-[88px] items-center justify-center rounded-full bg-white p-5 px-[17px] shadow-[0px_1px_8px_rgba(0,0,0,0.2)] xl:h-[126px] xl:w-[126px]\">","</div>",[_c('nuxt-img',{attrs:{"src":logo.attributes.iconUrl,"alt":'icon_' + i,"loading":"lazy"}})],1)}),0)],2)])]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"my-10 md:my-10\">","</section>",[_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div class=\"mb-[71px] flex items-center justify-center gap-2.5 text-center\"><div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div> <h3 class=\"inline-block text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl\">RECOGNITIONS &amp; AWARDS</h3> <div class=\"hidden h-px w-full bg-[#d5d5d5] sm:block\"></div></div> "),_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"mx-auto mb-10 grid max-w-[300px] grid-cols-1 gap-5 space-y-4 md:mb-16 md:max-w-none md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4\">","</div>",_vm._l((_vm.data),function(value,i){return _vm._ssrNode("<div"+(_vm._ssrClass("relative",{ 'md:before:!w-0 ': i === _vm.data.length - 1 }))+">","</div>",[_vm._ssrNode("<div class=\"flex flex-col items-center gap-4 rounded-t-[10px] bg-primary p-4 text-center md:min-h-[152px]\"><span class=\"h-12 w-12 rounded-full bg-white text-center text-lg font-bold leading-[48px] text-primary\">"+_vm._ssrEscape(_vm._s(i + 1))+"</span> <h3 class=\"text-xl font-bold text-white xl:text-[26px]\">"+_vm._ssrEscape(_vm._s(value.attributes.title))+"</h3></div> <div class=\"bg-white px-5 py-6 shadow-[0_3px_6px_rgba(0,0,0,0.16)] md:min-h-[120px] lg:min-h-[192px] lg:px-[30px] xl:min-h-[144px]\"><p class=\"text-[15px] leading-6 -tracking-[0.03]\">"+_vm._ssrEscape(_vm._s(value.attributes.description))+"</p></div> "),_vm._ssrNode("<div class=\"h-48 w-full md:h-32 lg:h-48\">","</div>",[_c('nuxt-img',{staticClass:"h-full w-full object-cover",attrs:{"format":"webp","src":value.attributes.imgUrl,"alt":"RECOGNITIONS & AWARDS","loading":"lazy"}})],1)],2)}),0)])],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"container py-24\">","</section>",[_vm._ssrNode("<div class=\"justify-content-center grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3\">","</div>",[_vm._ssrNode("<div class=\"justify-self-center\">","</div>",[_vm._ssrNode("<div class=\"flex flex-col items-center justify-center\">","</div>",[_c('nuxt-img',{staticClass:"h-10 w-10",attrs:{"format":"webp","src":"https://cdn-icons-png.flaticon.com/512/3621/3621464.png","alt":"arleodordar","loading":"lazy"}}),_vm._ssrNode(" <p>arleodordar</p>")],2)])])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/founder.vue?vue&type=template&id=4166756a&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3-0!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--13-0!./pages/founder.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var foundervue_type_script_lang_js_ = ({
  props: {
    data: {
      type: Array,
      default: () => [{
...
// CONCATENATED MODULE: ./pages/founder.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_foundervue_type_script_lang_js_ = (foundervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/founder.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_foundervue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var founder = __webpack_exports__["default"] = (component.exports);
