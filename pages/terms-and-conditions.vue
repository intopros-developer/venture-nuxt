<template>
    <div>
        <section
            class="relative bg-[url('/assets/img/terms-and-conditions-top.png')] bg-cover bg-[right_48%_top] bg-no-repeat pb-9 pt-[164px] md:bg-[center_top_25%] xl:pb-[75px]">
            ...
            <div class="container relative z-10 lg:px-[97px] xl:px-4">
                <div>
                    ...
                    <h1 class="mb-4 text-[38px] font-bold leading-[42px] text-white xl:text-[40px] xl:leading-[53px]">Terms
                        & Conditions</h1>
                </div>
            </div>
        </section>
        ...
        <section class="container lg:px-[97px] xl:px-4 mt-24 mb-60">
            <div v-for="(data, i) in content" :key="i" class="max-w-4xl" :class="{ 'mb-6': i !== content.length - 1 }">
                <h5 class="font-bold text-xl mb-8">{{ data.title }}</h5>
