                            ...
                            <li class="">
                                ...
                                >
                                    <div class="popper !fixed right-0 z-[60] !my-0 h-full !transform-none border-b border-t border-black/10 bg-white !text-left !text-base !shadow-none xl:!absolute xl:!top-[68px] xl:z-30 xl:h-auto">
                                        ...
                                        <div class="container">
                                            <ul class="block h-[calc(100vh-208px)] overflow-auto xl:h-auto xl:flex-grow xl:columns-3 xl:pt-6">
                            ...
                            <li>
                                ...
                                >
                                    <div class="popper !fixed right-0 z-[60] !my-0 h-full !transform-none border-b border-t border-black/10 bg-white !text-left !text-base !shadow-none xl:!absolute xl:!top-[68px] xl:z-30 xl:h-auto">
                                        <div class="relative block p-3 text-center xl:hidden">
                                            services
                                            <button class="absolute right-2.5 top-4 h-5 w-5 cursor-pointer" @click.stop="$refs.servicesPopper.doClose()">
                                                <icons-close />
                                            </button>
                                        </div>
                                        <div class="container">
...
<script>
    export default {
        ...
        computed: {
            ...
            insightCatalogue2() {
                return (
                    this.content?.insightCatalogue2?.data?.filter((d) =>
            ...
            insightCatalogue3() {
                return (
                    this.content?.insightCatalogue3?.data?.filter((d) =>
                        this.appliedFilters.length
                            ? this.appliedFilters.includes(d?.attributes?.typeFilter?.toLowerCase()) ||
                              this.appliedFilters.includes(d?.attributes?.mediaFilter?.toLowerCase()) ||
                              this.appliedFilters.includes(d?.attributes?.servicesSubFIlter?.toLowerCase()) ||
            ...
            insightCatalogue4() {
                return (
                    this.content?.insightCatalogue4?.data?.filter((d) =>
                        this.appliedFilters.length
                            ? this.appliedFilters.includes(d?.attributes?.typeFilter?.toLowerCase()) ||
                              this.appliedFilters.includes(d?.attributes?.mediaFilter?.toLowerCase()) ||
                              this.appliedFilters.includes(d?.attributes?.servicesSubFIlter?.toLowerCase()) ||
            ...
            insightCatalogue5() {
                return (
                    this.content?.insightCatalogue5?.data?.filter((d) =>
                        this.appliedFilters.length
                            ? this.appliedFilters.includes(d?.attributes?.typeFilter?.toLowerCase()) ||
                              this.appliedFilters.includes(d?.attributes?.mediaFilter?.toLowerCase()) ||
                              this.appliedFilters.includes(d?.attributes?.servicesSubFIlter?.toLowerCase()) ||
