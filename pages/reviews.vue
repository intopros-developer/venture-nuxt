<template>
    <div v-if="content">
        <section class="relative bg-primary-700 bg-cover bg-[right_48%_top] bg-no-repeat pb-9 pt-[164px] md:bg-[center_top_25%] xl:pb-[75px]" v-lazyload-bg="content.bannerImgUrl">
