    ...
    <div v-if="content">
        <section class="contact-heroform group relative overflow-hidden bg-gray-700 bg-cover bg-center bg-no-repeat">
            ...
            <div class="container relative z-10 px-10 pb-9 pt-[287px] md:bg-left md:px-4 lg:px-[97px] xl:px-4 xl:pb-20 xl:pt-[164px]">
                <div>
                    ...
                    <p class="w-full text-sm font-normal leading-5 text-[#FBFBFD] sm:max-w-[377px] md:max-w-[481px] md:text-base md:leading-[26px]" v-html="content.bannerDescription"></p>
                </div>
            </div>
        </section>
            ...
            <div class="container lg:px-[97px] xl:px-4">
                <div class="grid grid-cols-1 space-y-20 md:grid-cols-2 md:gap-5 md:space-y-0 lg:gap-24 xl:gap-36">
                    <div>
                        ...
                        <div class="pt-6 lg:pt-16">
                            <ul class="divide-y divide-[#d5d5d5] border-b border-t border-[#d5d5d5]">
                                <li v-for="(socialMedia, index) in section3Column1Data" :key="index" class="py-4">
                    ...
                    <div>
                        ...
                        <div class="pt-6 lg:pt-16">
                            <ul class="divide-y divide-[#d5d5d5] border-b border-t border-[#d5d5d5]">
                                <li v-for="(data, index) in section3Column2Data" :key="index" class="flex items-center justify-between py-4 text-lg text-[#202a36] hover:text-primary">
        ...
        <section class="py-10 md:py-16 xl:pb-0 xl:pt-[243px]">
            <div class="container lg:px-[97px] xl:px-4">
                ...
                <div v-for="(media, index) in section4Data" v-if="(!moreMediaMentions && index < 3) || moreMediaMentions" :key="media.id" class="grid grid-cols-1 items-center space-y-4 pt-[67px] lg:grid-cols-3 lg:gap-y-14 lg:space-y-0">
                    <div>
                        <div>
                    ...
                    <div class="col-span-2">
                        <div class="flex items-start gap-[17px]">
                            <div class="flex h-[62px] w-[62px] shrink-0 items-center justify-center rounded-full bg-white p-[7px] shadow-[0px_1px_8px_rgba(0,0,0,0.2)]">
                                <img :src="media.attributes.iconUrl" :alt="media.attributes.title" loading="lazy" />
                            </div>
        ...
        <section class="py-10 md:py-16 xl:pb-[176px] xl:pt-[108px]">
            <div class="container lg:px-[97px] xl:px-4">
                ...
                <div v-for="(release, index) in section5Data" v-if="(!morePressRelease && index < 3) || morePressRelease" :key="release.id" class="grid grid-cols-1 items-center space-y-4 pt-[67px] lg:grid-cols-3 lg:gap-y-14 lg:space-y-0">
                    <div>
                        <div>
                    ...
                    <div class="col-span-2">
                        <div class="flex items-start gap-[17px]">
                            <div class="flex h-[62px] w-[62px] shrink-0 items-center justify-center rounded-full bg-white p-[7px] shadow-[0px_1px_8px_rgba(0,0,0,0.2)]">
                                <img :src="release.attributes.iconUrl" :alt="release.attributes.title" loading="lazy" />
                            </div>
                            <div class="max-w-2xl pt-1 lg:pt-0">
        ...
        <common-tell-more-about-projects :featured-companies="section6Logos" :tell-us-more-data="section6Data" :tell-us-more-title="content.CTA1Title" :tell-use-more-subtitle="content.CTA1Description" :image-url="content.CTA1ImgUrl" />
                        ...
                        <div class="flex items-center gap-3 xl:gap-[52px]">
                            <div>
                                <nuxt-link to="/insights">
                                    <img :src="trend.attributes.imgUrl" :alt="trend.attributes.title" class="h-28 w-28 rounded-[5px] object-cover shadow-[0_3px_6px_rgba(0,0,0,0.44)] xl:h-[127px] xl:w-[127px]" loading="lazy" />
                                </nuxt-link>
                            </div>
                            <div>
                ...
                <div class="relative z-[1] grid grid-cols-1 md:grid-cols-2 lg:-mx-7 lg:grid-cols-4 lg:gap-y-28">
                    ...
                    >
                        <div class="h-[125px] w-full shadow-[0px_3px_6px_rgba(0,0,0,0.6)] xl:h-[173px]">
                            <img :src="insight.attributes.imgUrl" :alt="insight.attributes.Insightsource" class="h-full w-full object-cover" loading="lazy" />
                        </div>
                        <div class="flex h-[calc(100%-125px)] flex-col justify-between py-3 xl:h-[calc(100%-173px)] xl:py-[34px]">
                            ...
                            <div class="relative flex items-center justify-between">
                                ...
                                <button type="button">
                                    <common-share :is-show-save-btn="true" :custom-link="`/insights/${insight.attributes.singleInsightPageSlug}`" />
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <common-readytotalk :service-options="readyToTalkForm.services.data" :about-paragraph="readyToTalkForm.aboutParagraph" :title="readyToTalkForm.title" :talk-in-title="readyToTalkForm.talkInTitle" :img-url="readyToTalkForm.imgUrl" />
