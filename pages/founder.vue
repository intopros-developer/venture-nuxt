<template>
    <div>
        <section class="relative h-[400px] bg-gray-700 bg-cover bg-[right_32%_top] bg-no-repeat pb-12 md:bg-[center_top_8%] lg:h-[800px] xl:bg-[center_top_12%] xl:pb-[67px]" v-lazyload-bg="content.bannerImgUrl">
