<template>
    <div>
        <section class="relative bg-cover bg-[right_32%_top] bg-no-repeat pt-[207px] pb-9 md:bg-left xl:pt-[291px] xl:pb-20"
            :style="{ backgroundImage: `url(${content.bannerPara})` }">
            <div class="absolute top-0 left-0 z-0 h-full w-full bg-gradient-to-r from-[#2b3746] via-transparent"></div>
            <div
                class="absolute bottom-0 left-0 h-[161px] w-full bg-gradient-to-t from-[#202a36] via-transparent opacity-80 xl:h-[214px]">
            </div>
                ...
                <div>
                    <div>
                        <h1 class="mb-4 text-[38px] font-bold leading-[42px] text-white xl:text-[40px] xl:leading-[53px]">
                            {{ content.bannerTitle }}</h1>
                        <p class="mb-[18px] border-l-[3px] border-primary pl-2.5 leading-5 text-[#FBFBFD]"
                            v-html="`Bain knows that your privacy is important to you and takes user privacy very seriously. <br/> We are committed to protecting your personal data in accordance with this Privacy Policy.`">
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="py-10 text-[#353535] md:py-16 xl:py-20">
            <div class="container px-10 md:px-4 lg:px-[97px] xl:px-4">
                <div class="mb-10 flex items-center justify-center gap-[33px] text-center">
                    ...
                    <h2
                        class="text-[22px] font-bold uppercase leading-8 text-black sm:shrink-0 md:text-3xl md:leading-[43px]">
                ...
                <!--
                <div class="mb-10 space-y-7 font-medium xl:text-lg">
                    <common-custom-strapi-display classes="whitespace-pre-line xl:leading-[36px]" :data="content.paragraph"></common-custom-strapi-display>

                </div>
                <div class="mt-6 border-t border-[#707070]/20"></div>
                -->


                <common-custom-strapi-display classes="w-full" :data="content.definitions"></common-custom-strapi-display>
                <!--
                <div class="mt-6 border-t border-[#707070]/20"></div>
                <div v-for="(faq, i) in content.faqs" :id="`faq${i}`" :key="i"
                    class="border-b border-[#707070]/20 py-[34px]" :class="{ '!border-b': activeFaq === `faq${i}` }">
                    <div class="flex cursor-pointer items-center justify-between gap-5 md:gap-14"
                        @click="openFaq(`faq${i}`)">
                        <p class="flex-1 font-normal leading-[25px] -tracking-[-0.05px] text-[#353535]">{{ faq.fields.question }}</p>
                        <icons-minus v-if="activeFaq === `faq${i}`" class="w-4 flex-none text-primary/70 md:w-auto" />
                        <icons-plus v-else class="w-4 flex-none text-black/30 md:w-auto" />
                    </div>
                    <div v-if="activeFaq === `faq${i}`"
                        class="whitespace-pre-line pt-7 font-medium leading-8 text-[#353535] xl:text-lg md:leading-[36px]">
                        {{ faq.fields.answer }}</div>
                </div>

                <div class="mb-10 mt-[100px] flex items-center justify-center gap-[33px] text-center">
                    <div class="hidden h-px w-full bg-[#d5d5d5] sm:block"></div>
                    <h2 class="text-2xl font-bold uppercase text-black sm:shrink-0 xl:text-3xl">DEFINITIONS</h2>
                    <div class="hidden h-px w-full bg-[#d5d5d5] sm:block"></div>
                </div>
                <div class="space-y-7 font-medium md:mb-20 xl:text-lg">
                    <p class="whitespace-pre-line xl:leading-[36px]" v-html="content.definitions"></p>
                </div>
                -->
            </div>
        </section>
                ...
                if (this.activeFaq) {
                    setTimeout(() => {
                        ...
                        if (domRect !== null) {
                            ...
                            window.scrollTo({ top: domRect.top + document.documentElement.scrollTop - 80, behavior: 'smooth' });
                        }
                    }, 100);
                }
            },
