<template>
    <div>
        <section class="relative bg-gray-700 bg-cover bg-[right_32%_top] bg-no-repeat pb-9 pt-[207px] md:bg-left xl:pb-20 xl:pt-[291px]" v-lazyload-bg="content.bannerPara">
