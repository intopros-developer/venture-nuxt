                                                ...
                                                <ul class="sub-sub-menu !space-y-3">
                                                    <li>
                                                        <button aria-label="English" class="flex items-center gap-2" @click="switchLang('en')">
                                                            <nuxt-img format="webp" src="/images/flags/flag-global.webp" width="22" height="15" class="w-[22px]" alt="English" loading="lazy" />
                                                            <p>English</p>
                                                        </button>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="sub-sub-menu !space-y-3">
                                                    <li>
                                                        <button aria-label="Brazil (Português)" class="flex items-center gap-2" @click="switchLang('pt-br')">
                                                            <nuxt-img format="webp" src="/images/flags/flag-brazil.webp" class="w-[22px]" width="22" height="15" alt="Brazil (Português)" loading="lazy" />
                                                            <p>Brazil (Português)</p>
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button aria-label="Argentina (Español)" class="flex items-center gap-2" @click="switchLang('es-ar')">
                                                            <nuxt-img format="webp" src="/images/flags/flag-argentina.webp" class="w-[22px]" width="22" height="15" alt="Argentina (Español)" loading="lazy" />
                                                            <p>Argentina (Español)</p>
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button arial-label="Chile (Español)" class="flex items-center gap-2" @click="switchLang('es-cl')">
                                                            <nuxt-img format="webp" src="/images/flags/flag-chile.webp" class="w-[22px]" width="22" height="15" alt="Chile (Español)" loading="lazy" />
                                                            <p>Chile (Español)</p>
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button aria-label="Colombia (Español)" class="flex items-center gap-2" @click="switchLang('es-co')">
                                                            <nuxt-img format="webp" src="/images/flags/flag-colombia.webp" class="w-[22px]" width="22" height="15" alt="Colombia (Español)" loading="lazy" />
                                                            <p>Colombia (Español)</p>
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button aria-label="Canada" class="flex items-center gap-2" @click="switchLang('es-co')">
                                                            <nuxt-img format="webp" src="/images/flags/flag-canada.webp" class="w-[22px]" width="22" height="15" alt="Canada" loading="lazy" />
                                                            <p>Canada</p>
                                                        </button>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="sub-sub-menu !space-y-3">
                                                    <li>
                                                        <button aria-label="France(Français)" class="flex items-center gap-2" @click="switchLang('fr')">
                                                            <nuxt-img format="webp" src="/images/flags/flag-france.webp" class="w-[22px]" width="22" height="15" alt="France (Français)" loading="lazy" />
                                                            <p>France (Français)</p>
                                                        </button>
                                                    </li>
                                                    <li>
