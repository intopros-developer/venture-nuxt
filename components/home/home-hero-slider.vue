    ...
    <section class="hero-slider relative -mt-36 md:-mt-32">
        <div v-swiper:heroSlider="slider_options" class="swiper relative h-screen !min-h-[42rem]" :cleanup-styles-on-destroy="false">
            <div class="swiper-wrapper flex !min-h-[42rem] xl:!h-[100vh]">
                <div v-for="(slide, i) in slider" :key="i" class="swiper-slide !h-full overflow-hidden bg-gray-700">
                    ...
                    <div v-if="slide.attributes.slideVideoUrl">
                        <video
                            class="force-video-reload responsive-slide-video absolute inset-0 bottom-0 left-0 right-0 top-0 -z-10 h-full w-full object-cover"
                            :style="videoHeight"
                            autoplay
                            loop
                            muted
                            playsinline
                            :poster="slide.attributes.slideVideoThumbnailUrl"
                        >
                    ...
                    <div class="container relative z-10 px-10 md:px-4 lg:px-[97px] xl:px-4" :class="{ '': i === 0 }">
                        ...
                        >
                            <div class="flex-1">
                                <h2
                                    class="slide-text-animation-before slide-text-animation-after max-w-[295px] !whitespace-normal text-[26px] font-extrabold uppercase leading-[30px] text-white sm:max-w-[430px] sm:text-[38px] md:whitespace-nowrap xl:max-w-[626px] xl:text-[50px] xl:leading-[53px]"
