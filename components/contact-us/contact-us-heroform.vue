<template>
    <section class="contact-heroform hero-ultra-wide-height relative h-[770px] bg-primary-700 bg-cover bg-[center_top_25%] bg-no-repeat md:h-[730px] xl:h-[835px]" v-lazyload-bg="image">
