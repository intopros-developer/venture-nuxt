<template>
    <div v-if="content">
        <section class="relative bg-cover bg-[right_32%_top] bg-no-repeat pb-12 pt-[100px] md:bg-[center_top_8%] lg:pt-[166px] xl:bg-[center_top_12%] xl:pb-[67px]" v-lazyload-bg="content.bannerImgUrl">
