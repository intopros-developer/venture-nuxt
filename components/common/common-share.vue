<template>
    <div class="flex w-[53px] cursor-pointer items-center justify-between">
        <button v-if="isShowSaveBtn" aria-label="Save Button" class="text-[#5f5f60] hover:text-primary" :class="{ 'text-white': textWhite, 'text-[#5f5f60]': !textWhite }">
        ...
        >
                ...
                <ul class="text-base -tracking-[0.03px]" :class="{ 'text-white': textWhite, 'text-[#707070]': !textWhite }">
                    ...
                    <li class="border-b border-[#f1f1f1]">
                        <button
                            ...
                            class="group flex items-center gap-2 px-2.5 py-3.5 text-xs text-[#030303] transition-all duration-300 hover:bg-primary hover:text-white"
            ...
            <button slot="reference" aria-label="Share" class="transition-all duration-300 hover:text-primary" :class="{ '!text-primary': isOpenShare, 'text-white': textWhite, 'text-[#707070]': !textWhite }">
            ...
            shareLink(media) {
                const mediaLink =
                    media === 'facebook'
                        ...
                        : '';
                const url =
                    this.customLink && typeof this.customLink === 'string'
