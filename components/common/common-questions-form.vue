        ...
        <div id="question-box" class="container px-10 md:px-4 lg:px-[97px] xl:px-4">
            <div class="flex flex-col items-center justify-between gap-5 md:flex-row md:gap-10 lg:gap-20 xl:gap-[98px]">
                ...
                <div class="order-1 h-[236px] w-full flex-none overflow-hidden rounded-2xl bg-transparent md:order-2 md:w-[323px] xl:h-[364px] xl:w-[497px]">
                    <img v-if="isNoCapital" src="/images/que-9.webp" alt="Question - 9" loading="lazy" class="h-full w-full object-cover" />

                    <img v-else-if="questions[currentQuestion - 1]" :src="questions[currentQuestion - 1].attributes.imgUrl || '/images/grant-que-2.webp'" alt="Grant Que 2" class="h-full w-full object-cover" />

                    <img v-else src="/images/grant-que-2.webp" alt="Grant Que 2" loading="lazy" class="h-full w-full object-cover" />
                </div>
            </div>
        </div>
    </section>
