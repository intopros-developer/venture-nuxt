<template>
    <div v-lazyload-bg="imageUrl" class="bg-cover bg-[32%_top] bg-no-repeat pb-[72px] pt-[112px] lg:bg-[center_top_25%]">
        <div class="container lg:px-[97px] xl:px-4">
            <div class="items-start justify-between gap-5 lg:flex xl:gap-[107px]">
                <div class="relative">
                    <div class="custom-blur absolute -inset-5 m-auto h-full w-full bg-black/30 blur-2xl"></div>
